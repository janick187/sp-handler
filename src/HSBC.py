...
class HSBCReader:
    ...
    def __init__(self, DDV_Mapping):
        ...
        self.EUSIPA_Mapping = {
            ...
            "2100 Warrants": ["Open End-Turbo-Optionsscheine", "Call", "Turbo-Optionsscheine", "Open End-Turbo-Optionsscheine"],
            "2199 Miscellaneous Leverage without Knock-Out": [],
            "2200 Knock-Out Warrants": ["X-Turbos"],
            "2205 Open-end Knock-Out Warrants": ["X-Open End-Turbos"],
            "2210 Mini-Futures": ["Smart-Mini Future Zertifikate", "Mini Future Zertifikate"],
